    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Semantic Cache (Planned)", link: "/commands/semantic-cache" },
          { text: "Tool Cache (Planned)", link: "/commands/tool-cache" },
          { text: "Vector Search (Planned)", link: "/commands/vector" },
