...
// handleFlushAll flushes the (Phase 1: single) workspace. FLUSHALL and
// FLUSHDB are equivalent until Phase 7 introduces real multi-tenancy with
// more than one workspace to iterate.
